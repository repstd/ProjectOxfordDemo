...
public class WebServiceRequest {
    ...
    public String request(String url, String method, Map<String, Object> data, String contentType) throws ClientException {
        ...
        throw new ClientException("Error! Incorrect method provided: " + method);
    }
    ...
    public String post(String url, Map<String, Object> data, String contentType) throws ClientException {
        return webInvoke("POST", url, data, contentType);
    }

    public String patch(String url, Map<String, Object> data, String contentType) throws ClientException {
        return webInvoke("PATCH", url, data, contentType);
    }

    public String webInvoke(String method, String url, Map<String, Object> data, String contentType) throws ClientException {
        HttpPost request;
    ...
    public String put(String url, Map<String, Object> data) throws ClientException {
    ...
    public String delete(String url) throws ClientException {
